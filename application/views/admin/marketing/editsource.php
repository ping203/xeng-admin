        ...
        <form id="form" class="form" enctype="multipart/form-data" method="post" action="">
            <fieldset>
                ...
                <div class="formRow">
                    ...
                    <div class="formRight">
                        <span class="oneTwo"><input type="text" _autocheck="true" value="<?php echo $info[0]->name ?>" id="param_resource"   name="name"></span>
                ...
                <div class="formRow">
                    ...
                    <div class="formRight">
                        <span class="oneTwo"><input type="text" _autocheck="true" id="param_dissource" value="<?php echo $info[0]->display ?>"  name="display_name"></span>

                    </div>
                    <div class="clear"></div>
                </div>
                <div class="formSubmit">
                    <input type="button" class="redB" value="Cập nhật" id="editsource">
                </div>
            </fieldset>
        </form>
    </div>
    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p style="color: #0000ff">Bạn sửa source thành công</p>
            </div>
...
<script>
    $("#editsource").click(function () {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo admin_url('marketing/editsourceajax')?>",
            data: {

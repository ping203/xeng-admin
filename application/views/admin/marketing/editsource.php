                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 col-sm-4 col-xs-12">
                                            <input type="text" class="form-control" id="param_resource" value="<?php echo $info[0]->name ?>" name="resource">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 col-sm-4 col-xs-12">
                                            <input type="text" class="form-control" id="param_dissource" value="<?php echo $info[0]->display ?>" name="dissource">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-md-1 col-sm-2 col-xs-12">
                                            <input type="button" id="editsource" class="btn btn-success" value="Cập nhật">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="modal-dialog modal-sm">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <p style="color: #0000ff">Bạn cập nhật source thành công</p>
                                    </div>

<div class="content-wrapper">
    ...
    <?php else: ?>
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                <a href="<?php echo admin_url('marketing/addmedium') ?>" class="btn btn-block btn-success">Thêm medium</a>
            </ol>
        </section>
                                        ...
                                        <?php foreach($list as $row): ?>
                                            <tr>
                                                ...
                                                <td class="option">
                                                    ...
                                                    <a href="<?php echo admin_url('marketing/deletemedium/' . $row->id) ?>" title="Xóa"

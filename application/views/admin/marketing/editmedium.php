                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 col-sm-4 col-xs-12">
                                            <input type="text" class="form-control" id="param_remedium" value="<?php echo $info[0]->name ?>" name="remedium">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 col-sm-4 col-xs-12">
                                            <input type="text" class="form-control" id="param_dismedium" value="<?php echo $info[0]->display ?>" name="dismedium">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-md-1 col-sm-2 col-xs-12">
                                            <input type="button" id="editmedium" class="btn btn-success" value="Cập nhật">
                                        </div>
                                    </div>
                                </div>
